...
async function main() {
  ...
  const coffeeMenus = [
    ...
    { name: "바닐라라떼", englishName: "Vanilla Latte", description: "달콤한 바닐라 시럽이 들어간 라떼", basePrice: 5500, isBest: true, img: "coffee_valia_latte.png" },
  ...
  const nonCoffeeMenus = [
    { name: "인절미라떼", englishName: "Injeolmi Latte", description: "고소한 콩고물과 인절미가 어우러진 부드러운 라떼", basePrice: 5200, isBest: false, img: "noncoffee_injeolmi_latte.png" },
    { name: "흑임자라떼", englishName: "Black Sesame Latte", description: "진하고 고소한 흑임자 맛의 라떼", basePrice: 5200, isBest: false, img: "noncoffee_black_sesame_latte.png" },
    { name: "말차라떼", englishName: "Matcha Latte", description: "진한 말차와 우유가 어우러진 깔끔한 라떼", basePrice: 5200, isBest: true, img: "noncoffee_matcha_latte.png" },
    { name: "스트로베리라떼", englishName: "Strawberry Latte", description: "생딸기 퓨레와 우유가 층을 이루는 상큼한 라떼", basePrice: 5400, isBest: true, img: "noncoffe_strawberry_latte.png" },
    { name: "고구마라떼", englishName: "Sweet Potato Latte", description: "달콤한 고구마 페이스트가 들어간 따뜻한 라떼", basePrice: 5200, isBest: false, img: "noncoffee_sweet_potato_latte.png" },
    { name: "초코라떼", englishName: "Chocolate Latte", description: "진한 초콜릿과 우유가 어우러진 부드러운 라떼", basePrice: 5200, isBest: true, img: "noncoffee_choco_latte.png" },
    { name: "로즈베리티", englishName: "Roseberry Tea", description: "로즈와 베리 향이 어우러진 은은한 허브티", basePrice: 4800, isBest: false, img: "noncoffe_roseberry_tea.png" },
    { name: "캐모마일티", englishName: "Chamomile Tea", description: "마음을 편안하게 해주는 캐모마일 허브티", basePrice: 4800, isBest: true, img: "noncoffee_chamomile_tea.png" },
    { name: "얼그레이 밀크티", englishName: "Earl Grey Milk Tea", description: "얼그레이 홍차에 우유를 더한 은은한 밀크티", basePrice: 5200, isBest: true, img: "noncoffee_earl_grey_milk_tea.png" },
  ];
  ...
  const gelatoMenus = [
    { name: "바닐라 젤라또", englishName: "Vanilla Gelato", description: "바닐라 풍미가 진한 젤라또 아이스크림", ingredients: "우유, 바닐라빈, 계란, 설탕", nut: [190, 22, 15, 4, 9, 5, 50], basePrice: 5500, isBest: false, img: "gelato_vanilla.png" },
    { name: "말차 젤라또", englishName: "Matcha Gelato", description: "부드럽고 진한 말차맛 젤라또", ingredients: "우유, 말차가루, 계란, 설탕", nut: [210, 24, 14, 5, 10, 6, 55], basePrice: 5500, isBest: false, img: "gelato_matcha.png" },
    { name: "초코 젤라또", englishName: "Chocolate Gelato", description: "고급스러운 다크초콜릿으로 만든 초코 젤라또", ingredients: "우유, 코코아, 초콜릿, 설탕", nut: [220, 25, 16, 4, 12, 7, 60], basePrice: 5500, isBest: true, img: "gelato_choco.png" },
    { name: "피넛버터 젤라또", englishName: "Peanut Butter Gelato", description: "고소한 땅콩버터가 듬뿍 들어간 진한 젤라또", ingredients: "우유, 땅콩버터, 설탕, 크림", nut: [240, 20, 17, 5, 6, 6, 200], basePrice: 5500, isBest: false, img: "gelato_peanut_butter.png" },
    { name: "흑임자 젤라또", englishName: "Black Sesame Gelato", description: "깊고 고소한 흑임자 풍미의 젤라또", ingredients: "우유, 흑임자, 설탕, 크림", nut: [230, 22, 15, 5, 13, 7, 190], basePrice: 5500, isBest: false, img: "gelato_black_sesame.png" },
    { name: "쿠키앤크림 젤라또", englishName: "Cookies & Cream Gelato", description: "바닐라 젤라또에 쿠키 조각이 더해진 달콤한 맛", ingredients: "우유, 쿠키 크림, 바닐라, 설탕", nut: [250, 26, 18, 4, 15, 8, 210], basePrice: 5500, isBest: false, img: "gelato_cookies_and_cream.png" },
    { name: "레드베리 젤라또", englishName: "Red Berry Gelato", description: "상큼한 베리류의 맛이 어우러진 달콤한 젤라또", ingredients: "우유, 베리믹스, 설탕", nut: [200, 23, 17, 3, 8, 5, 140], basePrice: 5500, isBest: false, img: "gelato_red_berry.png" },
    { name: "인절미 젤라또", englishName: "Injeolmi Gelato", description: "인절미와 콩고물이 어우러진 달콤한 젤라또", ingredients: "우유, 인절미, 콩고물, 설탕", nut: [210, 21, 10, 4, 11, 6, 150], basePrice: 5500, isBest: false, img: "gelato_injeolmi.png" },
    { name: "얼그레이 젤라또", englishName: "Earl Grey Gelato", description: "얼그레이 홍차 향이 은은하게 나는 밀크 젤라또", ingredients: "우유, 얼그레이잎, 설탕, 크림", nut: [200, 22, 12, 4, 10, 6, 130], basePrice: 5500, isBest: false, img: "gelato_earl_grey.png" },
  ];
  ...
  const groupCupCone = await prisma.optionGroup.create({
    data: {
      name: "컵/콘",
      sortOrder: 5,
      options: {
        create: [
          { name: "컵", defaultExtraPrice: 0, sortOrder: 0 },
          { name: "콘", defaultExtraPrice: 0, sortOrder: 1 },
        ],
      },
    },
    include: { options: true },
  ...
  const gelatoProducts = await prisma.product.findMany({
    where: { categoryId: catGelato.id },
    select: { id: true },
  });
  const cupConeOptionIds = groupCupCone.options.map((o) => o.id);
  for (const product of gelatoProducts) {
    await prisma.productOption.createMany({
      data: cupConeOptionIds.map((optionId) => ({
        productId: product.id,
        optionId,
      })),
    });
